...
HD_PWD='X:/BI-SAP/mealy/mealy.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mealy_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mealy_vhdl.tcl -notrace
