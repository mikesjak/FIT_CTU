...
HD_PWD='X:/BI-SAP/zamecek_new/zamecek/zamecek.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zamek_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zamek_vhdl.tcl
