...
HD_PWD='X:/BI-SAP/funkce3/funkce3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log funkce3_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source funkce3_vhdl.tcl -notrace
