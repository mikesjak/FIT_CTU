...
HD_PWD='X:/BI-SAP/nasobicka/nasobicka.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nasobicka_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nasobicka_vhdl.tcl
