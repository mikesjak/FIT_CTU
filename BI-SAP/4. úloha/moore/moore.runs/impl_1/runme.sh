...
HD_PWD='X:/BI-SAP/moore/moore.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log moore_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source moore_vhdl.tcl -notrace
