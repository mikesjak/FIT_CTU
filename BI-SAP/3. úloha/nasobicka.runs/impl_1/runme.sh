...
HD_PWD='X:/BI-SAP/nasobicka/nasobicka.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nasobicka_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nasobicka_vhdl.tcl -notrace
