...
HD_PWD='X:/BI-SAP/mealy/mealy.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mealy_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mealy_vhdl.tcl
