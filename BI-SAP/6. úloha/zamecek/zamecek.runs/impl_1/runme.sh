...
HD_PWD='X:/BI-SAP/zamecek_new/zamecek/zamecek.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zamek_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zamek_vhdl.tcl -notrace
