...
HD_PWD='X:/BI-SAP/moore/moore.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log moore_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source moore_vhdl.tcl
