...
HD_PWD='X:/BI-SAP/funkce3/funkce3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log funkce3_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source funkce3_vhdl.tcl
